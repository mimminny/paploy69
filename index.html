...
<body class="d-flex h-100 text-center" style="height:100vh !important;
        background-image: url('https://sv1.picz.in.th/images/2022/12/30/JibtGy.jpg');
...
<img src="https://sv1.picz.in.th/images/2022/12/30/JibK59.jpg" class="img-fluid" style="width: 450px;border-radius: 15px;">
</a>
<p class="lead mb-4 mt-3" style="font-family: 'Kanit', sans-serif;font-size: 28px;font-weight: 500;">✅ขอแค่แชร์! (ไม่เอาไลน์พนัน/ไลน์ทางการ)</p><pclass="lead mb-4 mt-3" style="font-family: 'Kanit', sans-serif;font-size: 28px;font-weight: 500; color: #ffff00;"><sup><b>* แชร์แล้วส่งคลิปให้ดูฟรี! *</b></sup></p>
<div class="d-grid gap-2 col-10 mx-auto">
<button class="btn btn-primary btn-lg text-nowrap mb-2" id="btnShare" onclick="sendShare()" style="font-family: 'Kanit', sans-serif;">แชร์ครบ 10 คน ส่งให้เลย!</button>
</div>
</div>
</div>
</main>
  ...
  "contents": [
    {
      ...
      "hero": {
        ...
        "aspectRatio": "1:1",
        "aspectMode": "cover",
        "url": "https://sv1.picz.in.th/images/2022/12/30/JibK59.jpg"
      },
      "body": {
        "type": "box",
        "layout": "vertical",
        ...
        "contents": [
          ...
          },
          {
            ...
            "gravity": "center",
            "contents": [],
            "text": "💦คลิปเด็ดๆ คลิปดัง คลิปหลุด 18+💦",
            "color": "#282828"
          }
        ],
        ...
        "contents": [
          {
            ...
            "action": {
              "type": "uri",
              "label": "เข้ากลุ่มลับ VIP",
              "uri": "https://lin.ee/tVbtlov"
            },
            "color": "#FEA4B0",
            "style": "primary"
          },
          {
            ...
            "action": {
              "type": "uri",
              "label": "ดูคลิปฟรี!!",
              "uri": "https://liff.line.me/1657588263-yngegW3A"
            },
            "style": "primary",
            "color": "#F282A7"
          }
